...
export default function WbApiSyncForm() {
  ...
  async function handleSync() {
    ...
    const res = await fetch("/api/stock-import/wb-sync", { method: "POST" });
    setSyncing(false);
  ...
  return (
    <div style={{ maxWidth: 640, marginBottom: 24 }}>
      <div style={{ marginBottom: 8 }}>
        <strong>Синхронизация через WB API</strong> — остатки на складах WB и
        продажи за 28 дней, без ручной загрузки файла.
      </div>
      ...
      {result && (
        ...
        >
          Обработано артикулов: {result.total} · обновлена аналитика: {result.updated}
