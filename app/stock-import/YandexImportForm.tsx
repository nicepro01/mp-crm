...
export default function YandexImportForm() {
  ...
  async function handleFile(e: React.ChangeEvent<HTMLInputElement>) {
    ...
    const res = await fetch("/api/stock-import/yandex", { method: "POST", body: formData });
    setImporting(false);
  ...
  return (
    <div style={{ maxWidth: 640 }}>
      <label>
        Файл отчёта «Остатки на складе» ЯМ (.xlsx), как есть
