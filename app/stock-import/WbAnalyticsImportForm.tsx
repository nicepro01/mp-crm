...
export default function WbAnalyticsImportForm() {
  ...
  async function handleFile(e: React.ChangeEvent<HTMLInputElement>) {
    ...
    const res = await fetch("/api/stock-import/wb-analytics", { method: "POST", body: formData });
    setImporting(false);
  ...
  return (
    <div style={{ maxWidth: 640 }}>
      <label>
        Файл отчёта «Оборачиваемость» WB (.xlsx), как есть
