...
export default function YandexAnalyticsImportForm() {
  ...
  async function handleFile(e: React.ChangeEvent<HTMLInputElement>) {
    ...
    const res = await fetch("/api/stock-import/yandex-analytics", { method: "POST", body: formData });
    setImporting(false);
  ...
  return (
    <div style={{ maxWidth: 640 }}>
      <label>
        Файл отчёта «Аналитика продаж» ЯМ (.xlsx), как есть
